public class HealthRecord {
    ...
    public static int getTallestHeight() { return tallestHeight; }
    ...
    public static void displayClassDetails() {
        System.out.println("The tallest height (cm): " + tallestHeight);
        System.out.println("The shortest height (cm): " + shortestHeight);
        System.out.printf("The average height (cm): %.2f%n", averageHeight);
    }
}